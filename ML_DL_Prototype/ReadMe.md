Sentiment_analysis_BERT.ipynb file is used to get the IMDB data and then train it on a BERT based model. Model is trained with 25000 data points(80-20 split) and then saved.
